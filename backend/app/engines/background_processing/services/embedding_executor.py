"""Embedding job executor for vector generation and indexing.

Generates embeddings and rebuilds vector indexes at scale.
Does NOT interpret semantic meaning, rank correctness, or filter relevance.
"""
